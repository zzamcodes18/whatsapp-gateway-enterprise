...
<body class="h-full bg-[#F8FAFC] text-slate-900 font-sans antialiased overflow-hidden selection:bg-blue-600 selection:text-white" x-data="{ mobileOpen: false }">
    ...
    <div class="h-[100dvh] w-full flex overflow-hidden">
        ...
        <aside class="hidden md:flex w-64 lg:w-72 h-[100dvh] flex-col justify-between bg-white border-r border-slate-200/80 shadow-xs z-30 flex-shrink-0 select-none overflow-y-auto custom-scrollbar touch-scroll">
            ...
            <div class="p-5 space-y-6">
                ...
                <nav class="space-y-1 text-xs font-semibold">
                    @if(request()->routeIs('admin.*'))
                        ...
                        <a href="{{ route('admin.settings.index') }}" class="flex items-center gap-2.5 px-3 py-2.5 rounded-xl transition-all {{ request()->routeIs('admin.settings.*') ? 'bg-blue-600 text-white shadow-sm shadow-blue-500/25 font-bold' : 'text-slate-700 hover:bg-slate-100/80 hover:text-slate-900' }}">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-[100dvh] overflow-hidden">
            ...
            <!-- Top Viewport Navbar -->
            <header class="h-16 bg-white/95 border-b border-slate-200/80 px-4 sm:px-6 lg:px-8 flex items-center justify-between flex-shrink-0 z-20 shadow-xs">
    ...
    <div x-show="mobileOpen" class="fixed inset-0 z-50 md:hidden" style="display: none;" x-cloak>
        ...
        <div class="fixed inset-y-0 left-0 w-72 bg-white border-r border-slate-200 p-5 flex flex-col justify-between shadow-2xl z-10 overflow-y-auto custom-scrollbar touch-scroll">
            <div class="space-y-4">
