...
<body class="soft-canvas text-slate-900 font-sans antialiased selection:bg-blue-600 selection:text-white" x-data="{ mobileNav: false }">
    ...
    <header class="sticky top-0 z-40 bg-white/95 border-b border-slate-200/80 shadow-xs">
        ...
        <!-- Mobile Drawer -->
        <div x-show="mobileNav" class="md:hidden border-t border-slate-200 bg-white/98 px-5 py-4 space-y-2.5" style="display: none;" x-cloak @click.away="mobileNav = false">
