            ...
            <div class="space-y-3.5">
                ...
                <div class="p-3.5 bg-slate-50 border border-slate-200/80 rounded-xl flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-lg bg-red-100 text-red-600 flex items-center justify-center font-bold text-sm shadow-2xs">
                        ...
                        <div>
                            <h4 class="font-bold text-xs text-slate-800">Google Account</h4>
                            @if($user->google_id)
                            ...
                            @else
                                <p class="text-[11px] text-slate-400 font-medium">Belum Terhubung</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div>
                        @if($user->google_id)
                            <form action="{{ route('profile.unlink-social', 'google') }}" method="POST" onsubmit="return confirm('Lepaskan tautan akun Google Anda?')">
                                @csrf
                                <button type="submit" class="px-3 py-1.5 text-xs font-semibold text-rose-600 bg-rose-50 border border-rose-200 hover:bg-rose-100 rounded-lg transition-colors cursor-pointer">
                                    Lepas Tautan
                                </button>
                            </form>
                        @else
                            @if($enableGoogle)
                                <a href="{{ route('auth.google') }}" class="px-3 py-1.5 text-xs font-semibold text-blue-600 bg-blue-50 border border-blue-200 hover:bg-blue-100 rounded-lg transition-colors inline-flex items-center gap-1.5 cursor-pointer">
                                    <i data-lucide="link" class="w-3.5 h-3.5"></i>
                                    <span>Hubungkan</span>
                                </a>
                            @else
                                <span class="px-2.5 py-1 text-[11px] font-medium text-slate-400 bg-slate-100 rounded-lg">Nonaktif</span>
                            @endif
                        @endif
                    </div>
                </div>
                ...
                <div class="p-3.5 bg-slate-50 border border-slate-200/80 rounded-xl flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h4 class="font-bold text-xs text-slate-800">GitHub Account</h4>
                            @if($user->github_id)
                                <p class="text-[11px] text-emerald-600 font-semibold flex items-center gap-1">
                                    <i data-lucide="check-circle-2" class="w-3 h-3"></i> Terhubung
                                </p>
                    ...
                    <div>
                        ...
                        @else
                            @if($enableGithub)
                                <a href="{{ route('auth.github') }}" class="px-3 py-1.5 text-xs font-semibold text-blue-600 bg-blue-50 border border-blue-200 hover:bg-blue-100 rounded-lg transition-colors inline-flex items-center gap-1.5 cursor-pointer">
                                    <i data-lucide="link" class="w-3.5 h-3.5"></i>
                                    <span>Hubungkan</span>
                                </a>
                            @else
