        ...
        <div class="app-card p-5 bg-white dark:bg-[#111A2E] space-y-3 shadow-2xs">
            ...
            <div class="space-y-1.5 font-mono text-xs">
                <div class="flex justify-between">
                    ...
                    <strong class="text-slate-900 dark:text-white uppercase">{{ $device->status }}</strong>
                </div>
                <div class="flex justify-between">
                    <span class="text-slate-500 dark:text-slate-400">Metode:</span>
                    <strong class="text-slate-900 dark:text-white uppercase">{{ $device->connection_type }}</strong>
                </div>
                <div class="flex justify-between">
        ...
        <div class="app-card p-5 bg-white dark:bg-[#111A2E] space-y-3 shadow-2xs">
            ...
            <div class="space-y-1.5 font-mono text-xs">
                ...
                <div class="flex justify-between">
                    ...
                    <strong class="text-slate-900 dark:text-white">{{ $device->metadata['pushname'] ?? '-' }}</strong>
                </div>
            </div>
        </div>
